...
SELECT
    CASE
        WHEN cobertura_esgoto_pct < 30 THEN 'Baixa cobertura de esgoto'
        WHEN cobertura_esgoto_pct < 70 THEN 'Média cobertura de esgoto'
        ELSE 'Alta cobertura de esgoto'
    END AS faixa_cobertura_esgoto,
...
FROM indicadores
GROUP BY faixa_cobertura_esgoto
